...
{
    [Area("User")]
    public class PenilaianAALController : Controller
    {
        ...
        public PenilaianAALController(ApplicationDbContext context, ServiceUser su)
        {
            _context = context;
            _su = su;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var applicationDbContext = _context.PeriodeNIP
                .Where(p => p.IdPeriode == _idPeriode && p.NipAtas2 == _nip)
                .Include(p => p.Id)
        ...
        public IActionResult Pilih(string idperiode, string nip)
        {
            ...
            if (periodenip.Selesai != null)
            {
                ViewBag.Selesai = periodenip.Selesai;
            }
            return View(rows);
        }
        ...
        public IActionResult Pilih(DateTime Selesai,
            [Bind("Id,IdPeriode,Nip,WaktuSetuju2")]
            List<AjukanDiary> list)
        {
            ...
            if (list != null)
            {
                ...
                if (periodenip != null)
                {
                    ...
                    periodenip.DurasiAAL = DurasiAAL;
                    periodenip.Selesai = Selesai;
                    _context.Update(periodenip);
                    _context.SaveChanges();
                }
                return RedirectToAction("Index", new { idperiode, nip});
            }
